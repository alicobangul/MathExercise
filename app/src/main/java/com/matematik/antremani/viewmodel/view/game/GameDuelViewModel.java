...
public class GameDuelViewModel extends ViewModel {
    ...
    public GameDuelViewModel(Application application, SavedStateHandle state, GameSettings gameSettings, CreateQuestion createQuestion) {
