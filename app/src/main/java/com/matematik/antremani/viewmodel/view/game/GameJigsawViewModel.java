...
public class GameJigsawViewModel extends ViewModel {
    ...
    public GameJigsawViewModel(Application application, SavedStateHandle state, GameSettings gameSettings, CreateQuestion createQuestion) {
