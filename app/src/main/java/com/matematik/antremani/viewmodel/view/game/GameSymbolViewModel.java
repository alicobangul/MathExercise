...
public class GameSymbolViewModel extends ViewModel {
    ...
    public GameSymbolViewModel(Application application, SavedStateHandle state, GameSettings gameSettings, CreateQuestion createQuestion) {
