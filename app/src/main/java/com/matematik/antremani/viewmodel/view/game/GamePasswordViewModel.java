...
public class GamePasswordViewModel extends ViewModel {
    ...
    public GamePasswordViewModel(Application application, SavedStateHandle state, GameSettings gameSettings, CreateQuestion createQuestion) {
